...
class ToursPreprocessor(Preprocessor):
    ...
    def __init__(
        ...
        super().__init__(
            "tours", workflow_mode, data_source, spark_date, data_tag
        )
    ...
    def _pick_columns(
        ...
        columns_to_keep = ['_uid','ea_utm_source_0','ea_utm_source_1','ea_utm_source_2','ea_utm_source_3','ea_utm_source_4',
                            'ea_utm_campaign_0', 'ea_utm_campaign_1', 'ea_utm_campaign_2', 'ea_utm_campaign_3', 'ea_utm_campaign_4',
                            'et_utm_source_0', 'et_utm_source_1', 'et_utm_source_2', 'et_utm_source_3', 'et_utm_source_4',
                             'et_utm_campaign_0', 'et_utm_campaign_1', 'et_utm_campaign_2', 'et_utm_campaign_3', 'et_utm_campaign_4',
                             'utm_source_0', 'utm_source_1', 'utm_source_2', 'utm_source_3', 'utm_source_4',
                             'utm_campaign_0', 'utm_campaign_1', 'utm_campaign_2', 'utm_campaign_3', 'utm_campaign_4']
    ...
    def _column_split(self, data: pd.DataFrame, non_categorical_columns: list) -> Tuple[list, list]:
    ...
    def _extract_converted_individual_ids(self, id_data: pd.DataFrame, conversion_data: pd.DataFrame) -> pd.DataFrame:
    ...
    def etl(self) -> None:
        ...
        self._logger.info("Unifying column names across EA, ET, Legacy and 0-4 touchpoints")
        ...
        self._logger.info("Extracting converted individuals from an inner join of id and conversion data")
